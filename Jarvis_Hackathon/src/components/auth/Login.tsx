      ...
      <Card className="w-full max-w-md shadow-2xl border-white/5 bg-card/70 backdrop-blur-xl relative z-10 overflow-hidden">
        ...
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="flex flex-col items-center gap-1">
            <span className="text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-foreground to-foreground/70">
              Saarthi
            </span>
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/80">
              The Placement Prep Hub
            </span>
          </CardTitle>
